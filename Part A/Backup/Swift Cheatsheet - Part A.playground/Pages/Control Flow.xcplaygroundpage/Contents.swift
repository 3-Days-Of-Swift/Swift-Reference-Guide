//: ## ![The Swift Logo](swiftLogo43.png) Control Flow
//:
//: "Control flow" is control over the order of code execution.
//:
//: Code execution is ordered from top to bottom *(the first line down to the last)* unless a decision is made to alter the flow, diverting the path into a different direction.
//:
//: -------------------
//:
