//: ## ![The Swift Logo](swiftLogo43.png) Variables
//:
...
myVariable = "Some different text"

let myConstant: String = "This text cannot be changed once set"
//myConstant = "Some different text" // cannot assign new value
print("myVariable stores \(myVariable). myConstant stores \(myConstant)")
...
//let 1ExamScore = 50 // generates compiler error
