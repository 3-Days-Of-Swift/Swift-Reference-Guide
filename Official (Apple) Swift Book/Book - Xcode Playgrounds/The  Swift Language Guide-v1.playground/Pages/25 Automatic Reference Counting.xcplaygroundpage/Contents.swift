...
//: This is the official Apple Swift Language Guide converted into Swift playgrounds. Each published topic is now an editable and executable Swift playground with compilable runnable code examples that nicely demonstrate each language feature.
//:
...
//: To view this page online [click here - Automatic Reference Counting](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/automaticreferencecounting)
//:
//: -------------------
//:
