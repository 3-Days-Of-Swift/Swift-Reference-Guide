//: ## ![The Swift Logo](swiftLogo43.png) Functions
//:
//:
//: Functions are also known as algorithms; Grouped lines of code that are executed when the function is called.
//:
//: * Use the `func` keyword to declare a function.
//:
//: * Declare any input values within parentheses.
//:
