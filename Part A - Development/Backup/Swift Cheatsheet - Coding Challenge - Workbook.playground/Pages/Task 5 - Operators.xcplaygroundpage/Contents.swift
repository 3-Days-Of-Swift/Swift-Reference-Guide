...
//private func executePreviousResultIfNeeded() {
//    if equationBuilder.isReadyToExecute {
//        equalsPressed()
...
// Discuss: Responsibities of each type i.e. Calculator vs EquationBuilder
