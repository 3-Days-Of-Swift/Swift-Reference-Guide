...
//: -------------------
//:
//: The formulae to achieve this, is to divide the entered number after the decimal by the desired [base  10](https://www.google.com/search?q=base+10+explained) column.
//:
//: i.e. Entering `0.5` means adding `5 / 10` to the existing input.
//:
//: i.e. Entering `0.05` means adding `5 / 100` to the existing input.
//:
//: i.e. Entering `0.005` means adding `5 / 1000` to the existing input.
//:
//: -------------------
...
// Question: Calculate 0.009 using pow
9 / pow(10, 3)

// 2. How to apply this math to a button press
