//: ![3DaysOfSwift.com Logo](3DaysOfSwift-Footer.png) ©️
...
//:
//:
//: 👉 Save this file to keep a reference to **commonly-used Swift syntax**.
//:
//: Professionals use [GIT](https://www.google.com/search?q=what+is+GIT) and hosting services like [GitHub.com](https://github.com/3-Days-Of-Swift/Swift-Reference-Guide).
//:
/*:
 */
